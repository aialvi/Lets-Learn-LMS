...
const logos = [
  {
    name: "Lorem",
    url: "https://via.placeholder.com/250x50",
  },
  {
    name: "Lorem",
    url: "https://via.placeholder.com/250x50",
              ...
              <div className="mt-20">
                ...
                <div className="mt-6 sm:max-w-xl">
                  ...
                  <p className="mt-6 text-xl text-gray-500">
                    With our learning management system, end users can create
                    and teach courses, collaborate, and interact with other
                    members of their organization. We automate the entire
                    training process using intelligent algorithms that push
                    relevant content to learners based on their needs.
                  </p>
                </div>
                <form
                  action="#"
                    ...
                    <blockquote className="mt-8">
                      <div className="relative text-lg font-medium text-white md:flex-grow">
                        ...
                        <p className="relative">
                          Right away, I got to know how intuitive Learn is. It’s
                          very robust and elegant in what it offers yet is still
                          so easy to use. I’m glad I found it.
                        </p>
                      </div>

                      <footer className="mt-4">
                        <p className="text-base font-semibold text-rose-200">
                          Sarah Williams, MLS Administrator
                        </p>
                      </footer>
                    </blockquote>
                  </div>
            ...
            <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
              ...
              <div className="pt-12 sm:pt-16 lg:pt-20">
                ...
                <div className="mt-6 text-gray-500 space-y-6">
                  <p className="text-lg">
                    We're building a learning management system to help
                    learners, educators and businesses manage their learning
                    with a single tool.
                  </p>
                  <p className="text-base leading-7">
                    We're changing the way people learn and communicate. With
                    our learning platform, your team can teach courses,
                    collaborate, and interact with others in your organization
                    to find answers to questions. We help you automate the
                    entire learning process so you can spend more time focusing
                    on what matters.
                  </p>
                  <p className="text-base leading-7">
                    Our smart software solves all the hassle of managing
                    courses, giving you the freedom to focus on your business.
                    With Lets Learn, you can boost employee productivity, reduce
                    training costs, and increase ROI.
                  </p>
                </div>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
              <div>
                ...
                <p className="mt-6 max-w-3xl text-lg leading-7 text-gray-500">
                  Students often rely on after-school learning centers for study
                  help or test preparation, but many of the best ones are
                  concentrated in major cities. LMS like Let's Learn was created
                  to make education more accessible and affordable. Investors in
                  the technology industry, including Lorem, Ipsum, and Dolor
                  have invested in Let's Learn to help students find the right
                  learning center.
                </p>
                <div className="mt-6">
                  <a href="#" className="text-base font-medium text-rose-500">
              ...
              <div className="relative">
                <div className="sm:text-center">
                  ...
                  <p className="mt-6 mx-auto max-w-2xl text-lg text-rose-100">
                    We&apos;re launching our new product asap. Sign up to get
                    notified when we&rsquo;re ready.
                  </p>
                </div>
                <form
                  action="#"
      ...
      <footer className="mt-24 bg-gray-900 sm:mt-12">
        <div className="mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <p className="mt-8 text-center text-base text-gray-400">
            &copy; {year} Let's Learn, All rights reserved.
          </p>
        </div>
      </footer>
    </div>
